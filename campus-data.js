...
var CAMPUS_DATA = {
  campuses: [
    ...
    },
    {
      id: 'xianyou',
      name: '仙游校区',
      // 仙游校区不区分具体苑区，仅按男生/女生宿舍划分，楼栋只写「几号楼」
      areas: [
        { id: 'male',   name: '男生宿舍', buildings: ['1号楼','2号楼','3号楼','4号楼'] },
        { id: 'female', name: '女生宿舍', buildings: ['1号楼','2号楼','3号楼','4号楼','5号楼'] }
      ]
    }
  ],
  bathrooms: [
    ...
    { id: 'bath-male-2-2f',     campusId: 'xianyou',  areaId: 'male',     building: '2号楼', floor: '2F', name: '男生宿舍2号楼2F浴室', distance: 45, hours: '06:30–23:30', mapPos: { x: 100, y: 90,  floor: 2 } },
    { id: 'bath-male-4-1f',     campusId: 'xianyou',  areaId: 'male',     building: '4号楼', floor: '1F', name: '男生宿舍4号楼1F浴室', distance: 55, hours: '06:30–23:30', mapPos: { x: 130, y: 100, floor: 1 } },
    { id: 'bath-female-1-2f',   campusId: 'xianyou',  areaId: 'female',   building: '1号楼', floor: '2F', name: '女生宿舍1号楼2F浴室', distance: 50, hours: '06:30–23:30', mapPos: { x: 160, y: 110, floor: 2 } },
    { id: 'bath-female-3-2f',   campusId: 'xianyou',  areaId: 'female',   building: '3号楼', floor: '2F', name: '女生宿舍3号楼2F浴室', distance: 58, hours: '06:30–23:30', mapPos: { x: 190, y: 120, floor: 2 } }
  ]
};
